...
text = str(input("Type A News : "))

'''
data cleaning for a sentence
'''
...
# can change the save model
model_save_path = config.model_save_path
new = torch.load(model_save_path, map_location=torch.device(config.device))['state_dict']
